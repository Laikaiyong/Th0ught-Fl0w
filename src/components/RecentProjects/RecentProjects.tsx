        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            <PinContainer title={link} href={link}>
              <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh] bt-10'>
              ...
              <div className='flex items-center justify-between mt-7 mb-3 '>
                ...
                <div className='flex items-center justify-center'>
                  <p className='flex lg:text-base md:text-sm text-xs text-purple '>
                    Check Live Site
                  </p>
